...
function gen_manifest() {
    #manfest.plist中的信息
    local icon57_url="https://test-pm2.kfang.com/icons/$workspace-57.png"
    local icon512_url="https://test-app.kfang.com/icons/$workspace-512.png"
    local ipa_url="https://test-pm2.kfang.com/package/ios/$1"
...
# ======================================================
# 脚本执行区
security unlock-keychain -p "123456" /Users/mac/Library/Keychains/login.keychain
# 1. 解析脚本参数
#获取外界传入对应比变量的值
parse_cmd_param $@
...
make_dir_if_not_exist ~/Documents/app-center/package/ios
cp $workspace-$branch-$mode-$rn.ipa ~/Documents/app-center/package/ios/$workspace-$branchId.ipa
cp $package_root_dir/jenkins-workspace/$branchId.plist ~/Documents/app-center/package/ios/$workspace-$branchId.plist
#platId=4
#case $mode in
#Debug)
#    platId=4
...
downloadUrl=="itms-services://?action=download-manifest%26url=https://test-pm2.kfang.com/package/ios/$workspace-$branchId.plist"
# 16. 找出30天前的文件并删除
# 查找30天前的文件并删除
cd ./package/ios
echo "==== 开始清理30天前的数据 ===="
